...
public class DateUtil {
    ...
    /**
     *  Returns the current time in fixed format
     *   yyyy-MM-dd hh:mm:ss
     * @param date
     * @return
     */
    ...
    /**
     * @Description: Check if the string date matches the specified format
     */
